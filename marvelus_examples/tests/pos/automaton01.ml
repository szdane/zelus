(* The Zelus compiler, version 2.2-dev
  (2026-03-30-0:4) *)
open Ztypes
type state__254 = Automaton01_Down_22 | Automaton01_Up_21 
type state__253 = Automaton01_Down_16 | Automaton01_Up_15 
type ('c , 'b , 'a) _exec1 =
...
let exec1  = 
  ...
  let exec1_alloc _ =
    ();
    { r_39 = (false:bool) ;
      s_38 = (Automaton01_Down_16:state__253) ; ex_36 = (42:int) } in
  let exec1_reset self  =
    ((self.r_39 <- false ; self.s_38 <- Automaton01_Up_15 ; self.ex_36 <- 1):
    unit) in 
  let exec1_step self () =
...
let main (cstate_54:Ztypes.cstate) = 
  ...
  let main_alloc _ =
    ...
    { major_41 = false ;
      ...
      result_43 = (():unit) ;
      r_53 = (false:bool) ;
      s_52 = (Automaton01_Down_22:state__254) ; ex_50 = (42:int) } in
  ...
  let main_reset self  =
    ((self.i_46 <- true ;
      self.r_53 <- false ; self.s_52 <- Automaton01_Up_21 ; self.ex_50 <- 1):
    unit) in
