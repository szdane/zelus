...
data = pd.read_csv(
    os.path.join(path, "resultsdd.csv"),
    header=None,
...
# Noise
axs[3].plot(t, data["noise"], color="red")
...
# Titre
fig.suptitle(
    "Controlled mass spring system, descrete system & descrete PID",
    fontsize=16
)
...
# Sauvegarde image
plt.savefig(
    os.path.join(path, "resultsdd_PID.png"),
    dpi=300,
    bbox_inches="tight"
)
