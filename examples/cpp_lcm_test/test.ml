...
type ('i , 'h , 'g , 'f , 'e , 'd , 'c , 'b , 'a) _main =
  { mutable major_35 : 'i ;
    ...
    mutable h_41 : 'e ;
    mutable r_40 : 'd ;
    mutable s_39 : 'c ; mutable result_38 : 'b ; mutable vel_37 : 'a }
...
let main (cstate_48:Ztypes.cstate) = 
  ...
  let main_alloc _ =
    ...
    { major_35 = false ;
      ...
      result_38 = (():unit) ; vel_37 = (42:int) } in
    ...
    ((self.major_35 <- cstate_48.major ;
      (let (result_53:unit) =
           ...
           (let (z_42:bool) = (&&) self.major_35  ((>=) time_34  self.h_41) in
            ...
            (begin match trigger_36 with
                   | true ->
                       let _ = print_int self.vel_37 in
                       let _ = print_newline () in
                       self.result_38 <- (move_robot_ml (self.vel_37))
